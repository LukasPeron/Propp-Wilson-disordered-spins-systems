...
# Define standard ticks based on the ER graph parameters
...
plt.savefig(save_path+f'algo/ER_glassy_number_star_state_d_{d}_N_{N}.png')
plt.savefig(save_path+f'algo/ER_glassy_number_star_state_d_{d}_N_{N}.svg')