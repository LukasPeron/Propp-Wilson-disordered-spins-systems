...
# np.save(save_path + f"data/algo/random/ER_{N}_configs_coal_time.npy", t_coal_beta)

# load the data
t_coal_beta = np.load(save_path + f"data/algo/random/ER_{N}_configs_coal_time.npy")
...
plt.yscale("log")
plt.legend()
plt.savefig(save_path + f"figures/algo/random/ER_{N}_configs_coal_time.png", dpi=300)
plt.close()