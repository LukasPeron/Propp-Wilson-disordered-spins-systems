"""
This script is made to analyze the coalescence time of the BC algorithm for a disordered spin system on an ER graph at different sizes and different values of beta. 
"""
...
Plot_coal_time(save_name=save_name, beta_BD=np.nan, beta_c=beta_SG, beta_uni=beta_uni, max_beta=max_beta, sampler=F_beta_Glauber, d=d)