...
# for beta in betas:
#     Nb_star(N=N, beta=beta, G=G, couplings=couplings, beta_c=beta_pm, save_name=save_name, n_runs=10)

Plot_nb_star(save_name=save_name, beta_BD=np.nan, beta_c=beta_pm, max_beta=max_beta, sampler=F_beta_Glauber)