...
Nb_star(N=N, G=G, couplings=couplings, beta_c=beta_SG, max_beta=max_beta, save_name="RR", n_runs=25)

Plot_nb_star(save_name="RR", beta_BD=beta_BD, beta_c=beta_SG, max_beta=max_beta)