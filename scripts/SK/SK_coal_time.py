...
for beta in betas:
    Coal_time(N_list=N_list, beta=beta, d=np.nan, max_beta=max_beta, save_name=save_name, n_runs=10)

Plot_coal_time(save_name=save_name, beta_BD = beta_BD, beta_c=beta_SG, beta_uni=beta_uni, max_beta=max_beta)